...
export default function AssessmentList() {
  ...
  const [selectedAssessmentForDelivery, setSelectedAssessmentForDelivery] =
    useState<AvailableAssessment | null>(null);
  ...
  useEffect(() => {
    const result = assessments.filter((assessment) => {
      const matchesSearch =
  ...
  const handleDeliveryCreated = (deliveryDetails: any) => {
    ...
    const newDelivery = {
      ...
      status: "scheduled" as const, // Initial status
    ...
    <div className="p-4 sm:p-8">
      ...
      <div className="mb-6 flex flex-col sm:flex-row gap-4">
        ...
        <Select
          ...
          onValueChange={(value) =>
            setCategoryFilter(value as AssessmentCategory | "all")
          }
        >
