...
import { Search, Edit, MailWarning, CalendarClock, MoreHorizontal, Trash2, Send } from 'lucide-react'; // Added icons
              ...
              filteredDeliveries.map((delivery) => {
                ...
                return (
                  <TableRow
                    ...
                    className={nearExpiry ? 'bg-yellow-50' : ''} // Highlight near expiry
                  >
